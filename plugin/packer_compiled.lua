...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/playground",
  ...
  undotree = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/undotree",
